    ...
    <div className="p-6 space-y-6 animate-in slide-in-from-right-4 duration-300 h-full flex flex-col bg-slate-50/50">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          <h2 className="text-2xl font-black text-slate-800 leading-tight">Avocat Maraude</h2>
        ...
        {step === 3 && (
          <div className="space-y-6 text-center animate-in zoom-in-95">
             <div className="bg-slate-900 p-8 rounded-[3rem] text-white shadow-2xl relative overflow-hidden">
                ...
                <h4 className="text-xl font-black">Certification Justice Maraude</h4>
      ...
      <div className="pt-4 flex gap-3">
        {step < 4 ? (
          <button onClick={handleNext} disabled={(step === 1 && (!formData.firstName || !formData.phone))} className="w-full py-5 bg-slate-800 text-white rounded-3xl font-black uppercase text-xs tracking-widest shadow-xl">Continuer</button>
        ) : (
